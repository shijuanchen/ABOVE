...
rf_folder_path = r'/projectnb/landsat/projects/ABOVE/CCDC/Bh07v07/out_classes'
output_file_path = r'/projectnb/landsat/users/shijuan/above/dist_year/Bh07v07_year.tif'
tile_name = 'Bh07v07'
year_avail = np.arange(2000, 2014, dtype=np.int16)
...
for year in year_avail:
    rf_file = rf_folder_path+'/'+tile_name+'_FF_FN_NF_NN_' + str(year) +'_cl.tif'
    print(rf_file)
