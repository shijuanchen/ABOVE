...
tile_name <- args[1]
out_dir = "/projectnb/landsat/users/shijuan/above/training_data/0725_training/NN/"
tc_dir = "/projectnb/landsat/projects/ABOVE/CCDC/"%+%tile_name%+%"/out_tc_4type/"
shp_loc = "/projectnb/landsat/users/shijuan/above/training_data/0725_training/NN/"%+%tile_name%+%"_pts_NN.shp" # can also be a directory
